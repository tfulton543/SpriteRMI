...
/**
 * This class defines a game session. It contains methods which enable the
...
public interface SpriteSessionInterface extends Remote {
	/**
	 * This method creates a new sprite object on the server with a starting
	 * position which corresponds to the client's mouse click
	 * 
	 * @param e
	 *            The MouseEvent created by the client clicking in the client
	 *            panel
	 * @return True if the sprite was created successfully, otherwise returns
	 *         false
	...
	/**
	 * This method allows the user to set the colour property of their unique
	 * spriteSession. All sprites created by their spriteSession will use this
	 * colour.
	 * 
	 * @param color
	 *            The colour which you wish to use
	 * @throws RemoteException
	 */
	...
	/**
	 * This method gets the Y (height) value of the playing area from the
	 * server. It uses this value to setup the height of the display panel
	 * correctly.
	 * 
	...
	/**
	 * This method returns a list of all the sprite objects being managed by the
	 * server
	 * 
	 * @return ArrayList<Sprite> containing all the sprites being managed by the
	 *         server
	 * @throws RemoteException
	 */
	 ...
	 * 
	 * @param colour
	 *            The colour which you wish to remove from the list.
	 * @return
	 */
